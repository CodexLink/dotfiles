  ...
  config = function()
    ...
    require("kanagawa").setup({
      ...
      overrides = {
        ...
        BufferLineDevIconHtmlSelected = { bg = kanagawa_colors.autumnYellow, fg = kanagawa_colors.sumiInk1 },
        ...
        BufferLineDevIconPsScriptModulefileSelected = { bg = kanagawa_colors.autumnYellow, fg = kanagawa_colors.sumiInk1 },
        ...
        BufferLineDevIconYamlSelected = { bg = kanagawa_colors.autumnYellow, fg = kanagawa_colors.sumiInk1 },
        BufferLineDuplicateSelected = { bg = kanagawa_colors.autumnYellow, fg = kanagawa_colors.sumiInk1 },
