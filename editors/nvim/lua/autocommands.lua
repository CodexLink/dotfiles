---@module autocommands
-- @description Just a set of autocommands that has to be initialized as the second priority module for plugins to adjust later on.
...
vim.api.nvim_create_autocmd("User", { pattern = "ForceLSPWakeup", callback = function () vim.notify_once("LSP Wakeup initiated!", vim.log.levels.WARN) end, group = custom_event })
