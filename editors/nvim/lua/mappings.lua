...
wk.register({
	...
	["<M-F1>"] = { function() require("telescope").load_extension("file_browser") require("telescope").extensions.file_browser
			.file_browser() end,
	...
	["<Leader>"] = {
		a = { function() notifier({ cmd = function() require("neogen").generate() end,
			message = "neogen: Code annotation added!", opts = mapping_default_opts }) end, "neogen: Annotate code context" },
		G = {
			name = "gitsigns.nvim",
			b = { function() notifier({ cmd = function() require("gitsigns").toggle_current_line_blame() end,
				message = "gitsigns: Line blame toggled.", opts = mapping_default_opts }) end, "Toggle line blame" },
			d = { function() notifier({ cmd = function() require("gitsigns").diffthis() end,
				message = "gitsigns: Diff view (at current line) activated.", opts = mapping_default_opts }) end,
				"'diffthis' on current line" },
			D = { function() notifier({ cmd = function() require("gitsigns").diffthis("~") end,
				message = "gitsigns: Diff view (at whole file) activated.", opts = mapping_default_opts }) end,
				"`diffthis` on whole file" },
			h = { function() notifier({ cmd = function() require("gitsigns").preview_hunk() end,
				message = "gitsigns: Hunk on current line preview, activated", opts = mapping_default_opts }) end, "Preview hunk" },
			H = { function() notifier({ cmd = function() require("gitsigns").preview_hunk_inline() end,
				message = "gitsigns: Hunk on current line inline-preview, activated", opts = mapping_default_opts }) end,
		...
		T = { function() notifier({ cmd = function() require("twilight").toggle() end,
			message = "twilight: Code dimming toggled.", opts = mapping_default_opts }) end, "twilight.nvim: Toggle code dimming" },
		w = {
			name = "windows.nvim",
			["="] = { function() notifier({ cmd = function() require("windows.commands").equalize() end,
				message = "All windows were equalized.", opts = mapping_default_opts }) end, "Equalize" },
			["+"] = { function() notifier({ cmd = function() require("windows.commands").maximize() end,
				message = "Current window set to maximized.", opts = mapping_default_opts }) end, "Maximize" },
			["-"] = { function() notifier({ cmd = function() require("windows.commands").maximize_vertically() end,
				message = "Current window set to maximize vertically.", opts = mapping_default_opts }) end, "Maximize vertically" },
			["_"] = { function() notifier({ cmd = function() require("windows.commands").maximize_horizontally() end,
				message = "Current window set to maximize horizontally", opts = mapping_default_opts }) end, "Maximize horizontally" },
		}
	},
	...
	["<M-c>"] = { function() notifier({ cmd = function() require("bufferline").close_buffer_with_pick() end,
		message = "Selected buffer closed!", opts = mapping_default_opts }) end, "bufferline: Pick a buffer to close." }, -- [1]
	["<M-d>"] = { function() notifier({ cmd = function() require("bufferline").pick_buffer() end,
		message = "Selected buffer displayed!", opts = mapping_default_opts }) end, "bufferline: Pick a buffer to display." }, -- [1]
	...
	["<M-v>"] = { function() notifier({ cmd = function() require("treesj").toggle() end,
		message = "treesj: toggled to wrap/one-line a context.", opts = mapping_default_opts }) end,
	...
	["<M-F>"] = { function() notifier({ cmd = function() vim.lsp.buf.format({ async = true }) end,
		message = "Formatting done!", opts = mapping_default_opts }) end, "utils: Code Format (Async)" },
